                ...
                VStack {
                    ...
                    ScrollView(showsIndicators: false) {
                        ...
                        VStack(spacing: 24) {
                          ...
                          ExpenseDetailedListView(title: "Transaction type", description: viewModel.expenseObj.type == TransactionType.TRANS_TYPE_INCOME.rawValue ? "Income" : "Expense" )
                          ExpenseDetailedListView(title: "Tag", description: TransactionTags.getTransactionTitle(viewModel.expenseObj.tag ?? ""))
